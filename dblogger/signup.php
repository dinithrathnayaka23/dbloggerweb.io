  ...
  <body class="min-h-screen flex flex-col md:flex-row bg-black text-white">
    ...
    >
      <div class="w-full max-w-md bg-gray-800 p-8 rounded-2xl shadow-lg">
        <h2 class="text-3xl font-bold mb-8 text-cyan-400 text-center">
          Sign Up
        </h2>
        ...
        <form class="space-y-5" method="POST" action="register.php">
          <!-- Full Name -->
          <div>
            <label class="block text-sm font-semibold mb-1"><i class="fa-solid fa-user text-white"></i> Full name:</label>
            <input
              type="text"
              name="full_name"
          ...
          <!-- Email -->
          <div>
            <label class="block text-sm font-semibold mb-1"><i class="fa-solid fa-envelope text-white"></i> Email:</label>
            <input
              type="email"
              name="email"
          ...
          <!-- Password -->
          <div>
            <label class="block text-sm font-semibold mb-1"><i class="fa-solid fa-key text-white"></i> Password:</label>
            <div class="relative">
              <input
                type="password"
                id="password"
          ...
          <!-- Confirm Password -->
          <div>
            <label class="block text-sm font-semibold mb-1"><i class="fa-solid fa-lock text-white"></i> Confirm Password:</label>
            <div class="relative">
              <input
                type="password"
                id="confirmPassword"
        ...
        <p class="text-center text-sm text-gray-400 mt-6">
          ...
          <a href="login.php" class="text-cyan-400 hover:underline">Login</a>
        </p>
      </div>
    </div>
  </body>
